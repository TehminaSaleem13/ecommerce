...
class CartItemsController < ApplicationController
  ...
  before_action :set_cart, only: [:create, :apply_coupon, :update, :destroy]
  ...
  def apply_coupon
    ...
    if @cart.apply_coupon(coupon_code)
      redirect_to cart_path, notice: "Coupon '#{coupon_code}' applied successfully! You got #{@cart.discount_percentage}% off."
    else
